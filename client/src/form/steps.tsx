...
export const STEPS: StepDef[] = [
  { id: "about", sectionId: "about", heading: "Who's submitting this Country Crisis Action Agenda?", fields: [
  ...
  { id: "realityCheck", sectionId: "situation", heading: "At a glance: reality check", helper: "Add 3 to 6 key indicators that show the scale of the crisis.", fields: ["situation.realityCheck"], Component: RealityCheckStep },
